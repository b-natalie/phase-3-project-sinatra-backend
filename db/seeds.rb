...
s1 = Service.create(name: "Vinyasa Yoga", description: "Yoga characterized by stringing postures together so that you move from one to another, seamlessly, using breath.", time: DateTime.new(2021, 10, 15, 9, 0), duration: 60, price: 10, instructor: "Shawna")
s2 = Service.create(name: "Hot Yoga", description: "Yoga as exercise performed under hot and humid conditions, resulting in considerable sweating", time: DateTime.new(2021, 10, 15, 8, 0), duration: 50, price: 15, instructor: "Jae")
s3 = Service.create(name: "Meditation", description: "This class will focus on slow, deep breathing techniques and meditative postures. Move gracefully and synchronize the breath with the movement.", time: DateTime.new(2021, 10, 11, 11, 0), duration: 30, price: 12, instructor: "Natalie")
s4 = Service.create(name: "Meditation (1 hour)", description: "This class will focus on slow, deep breathing techniques and meditative postures. Move gracefully and synchronize the breath with the movement.", time: DateTime.new(2021, 10, 12, 7, 0), duration: 60, price: 15, instructor: "Joe")
s5 = Service.create(name: "Aquatics", description: "Splashing, stretching, twisting, even shouting, laughing, hooting, and hollering. If you're up for some real fun while getting fit, give this class a go.", time: DateTime.new(2021, 10, 14, 12, 0), duration: 45, price: 15, instructor: "Gabriel")
s6 = Service.create(name: "Spin", description: "Ride to driving beats that will improve your cardio endurance and muscular strength. This workout is designed for multi levels of fitness, leaving you drenched in sweat and inspired to come back for more.", time: DateTime.new(2021, 10, 14, 17, 0), duration: 50, price: 18, instructor: "Gabe")
s7 = Service.create(name: "Hip Hop Dance", description: "With routines set to old and new school hip hop music, you will want to get up and move. Don't worry if you can't dance, this class will have you moving like a Hip Hop master in no time.", time: DateTime.new(2021, 10, 14, 17, 0), duration: 60, price: 18, instructor: "Melissa")
